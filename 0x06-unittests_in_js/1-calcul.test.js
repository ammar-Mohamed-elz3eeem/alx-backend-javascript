...
describe('calculateNumber', () => {
  ...
  describe('type = "DIVIDE"', () => {
    it('equal positive numbers', () => {
      assert.strictEqual(calculateNumber(3.0, 2.0, 'DIVIDE'), 1.5);
    });
    ...
    it('a = 0 & b positive numbers', () => {
      assert.strictEqual(calculateNumber(0.0, 2.0, 'DIVIDE'), 0);
    });
    ...
    it('0 / 0 = "Error"', () => {
      assert.strictEqual(calculateNumber(0.0, 0.0, 'DIVIDE'), 'Error');
    });
  });
});
